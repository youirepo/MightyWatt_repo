...
// calibration procedure for FW_VERSION "2.3.1"
...
{      
  ...
  delay(100);
  for (int i = 41 ; i <= 4095; i = i + 500) // 9 calibration points
  {    
    dac = i;
    setDAC();
    delay(100); // equilibrate
  ...
  */
  ...
  Serial.println("dac");
  delay(100);
  for (int i = 4095; i >= 0; i = i - 579) // 8 calibration points
  {    
    dac = i;
    setDAC();
    delay(100); // equilibrate
